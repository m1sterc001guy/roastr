...
rec {
  ...
  ciTestAllBase = { times }: craneLibTests.mkCargoDerivation {
    ...
    buildPhaseCargoCommand = ''
      ...
      cp scripts/tests/always-success-test.sh scripts/tests/always-success-test.sh.back
      ...
      cp -f scripts/tests/always-success-test.sh.back scripts/tests/always-success-test.sh
    '';
  };
